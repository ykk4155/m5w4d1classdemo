  ...
  render() {
    ...
    return (
      <div className="container-div">
        <div id="div-element" onClick={(e) =>
          this.handleClick(e)}>I am DIV
        </div>

        <span id="span-element" onClick={(e) =>
          this.handleClick(e)}>I am SPAN
        </span>
        <br></br>
        ...
        <a id="link-element" href="" onClick={(e) =>
          this.handleClick(e)}>
          I am a LINK
        </a>
